...
// â”€â”€â”€ LoginPhoneAuthScreen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Used in LOGIN flow only
// After OTP verified â†’ LoginPinScreen
// (For signup flow use PhoneAuthScreen instead)
...
class _LoginPhoneAuthScreenState extends State<LoginPhoneAuthScreen>
  ...
  Future<void> _sendOtp() async {
    ...
    // TODO: SecurityService.sendOtp(phone)
  ...
  Future<void> _verifyOtp() async {
    ...
    // TODO: SecurityService.verifyOtp(phone, otp)
    await Future.delayed(const Duration(seconds: 2));

    setState(() => _loading = false);

    // âœ… LOGIN flow â€” go to PIN screen after OTP
    Navigator.push(
      context,
  ...
  void _onOtpChanged(String val, int index) {
    if (val.length == 1 && index < 5) _otpFocus[index + 1].requestFocus();
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Text(
                            _otpSent
                                ...
                                : "We'll verify your number to log you in",
                            style: TextStyle(
                              fontSize: 13.5,
                    ...
                    if (!_otpSent)
                      AnimatedBuilder(
                        ...
                        builder: (_, child) => Transform.translate(
                          offset: Offset(
                              math.sin(_shake.value * math.pi * 8) * 8, 0),
                          child: child,
                        ),
                        child: _PhoneField(
                    ...
                    // â”€â”€ Resend timer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                    if (_otpSent)
                      Center(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(18),
          borderSide: const BorderSide(color: Color(0xFF3568F5), width: 1.5),
        ),
      ),
    );
  }
