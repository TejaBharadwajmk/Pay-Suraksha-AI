...
// â”€â”€â”€ FaceVerifyLoginScreen (Screen 2e) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Shown after correct PIN entry during login
// Success â†’ Dashboard

class FaceVerifyLoginScreen extends StatefulWidget {
  const FaceVerifyLoginScreen({super.key});

  @override
  State<FaceVerifyLoginScreen> createState() => _FaceVerifyLoginScreenState();
}

class _FaceVerifyLoginScreenState extends State<FaceVerifyLoginScreen>
  ...
  Future<void> _startScan() async {
    ...
    // TODO: SecurityService.verifyFace()
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Final step â€” face verification to log in",
                      style: TextStyle(
                          fontSize: 13.5,
                    ...
                    // CTA button
                    _ActionButton(
                      label: _verified ? "Enter Dashboard" : "Verify Face",
                      loading: _scanning,
                      enabled: !_scanning,
                      isSuccess: _verified,
                      onTap: _verified
                          ? () {
                              ...
                              ScaffoldMessenger.of(context)
                                ...
                                content: Text("â†’ Navigate to Dashboard"),
